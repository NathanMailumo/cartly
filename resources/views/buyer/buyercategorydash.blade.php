                        ...
                        <div class="mt-4">
                            <div class="flex items-center justify-between">
                                ...
                                <form action="{{route('buyer.addToCart')}}" method="POST" class="flex items-center">
                                    ...
                                    <button type="submit" class="px-3 py-1.5 bg-amber-500 hover:bg-amber-600 active:scale-95 text-slate-950 font-bold rounded-xl text-xs transition-all flex items-center gap-1.5">
