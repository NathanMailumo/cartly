    ...
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
            ...
            <aside class="lg:col-span-3 border border-[#cfc8bc] bg-[#faf8f4] self-stretch">
                ...
                <div class="divide-y divide-[#cfc8bc]">
                    <a href="{{ route('login') }}" class="flex gap-3 p-3 hover:bg-[#f0ebe1] transition">
                        ...
                        <span class="flex-1"><strong class="block font-masthead text-sm">Wireless Headphones</strong><em class="block font-serif-body text-[11px] text-[#787167]">For music and calls</em><small class="font-editorial-sans text-[9px]">N65,000</small></span><i class="fa-solid fa-arrow-right self-center text-[9px] text-[#787167]"></i>
                    </a>
                    <a href="{{ route('login') }}" class="flex gap-3 p-3 hover:bg-[#f0ebe1] transition">
                        ...
                        <span class="flex-1"><strong class="block font-masthead text-sm">Running Shoes</strong><em class="block font-serif-body text-[11px] text-[#787167]">Comfortable everyday pair</em><small class="font-editorial-sans text-[9px]">N128,800</small></span><i class="fa-solid fa-arrow-right self-center text-[9px] text-[#787167]"></i>
                    </a>
                    <a href="{{ route('login') }}" class="flex gap-3 p-3 hover:bg-[#f0ebe1] transition">
                        ...
                        <span class="flex-1"><strong class="block font-masthead text-sm">Classic Wristwatch</strong><em class="block font-serif-body text-[11px] text-[#787167]">Simple and smart</em><small class="font-editorial-sans text-[9px]">N92,200</small></span><i class="fa-solid fa-arrow-right self-center text-[9px] text-[#787167]"></i>
                    </a>
                </div>
        ...
        <section id="categories" class="border-y border-[#cfc8bc] mt-8 py-7">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
                <a href="{{ route('register.form') }}" class="border border-[#cfc8bc] bg-white p-3 hover:border-[#161413] transition text-center"><img src="https://images.unsplash.com/photo-1546519638-68e109498ffc?auto=format&fit=crop&w=300&q=80" alt="Basketball" class="w-full h-24 object-contain"><span class="block font-editorial-sans text-[9px] uppercase tracking-[0.14em] mt-3">Basketballs</span></a>
                ...
                <a href="{{ route('register.form') }}" class="border border-[#cfc8bc] bg-white p-3 hover:border-[#161413] transition text-center"><img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=300&q=80" alt="Sneakers" class="w-full h-24 object-contain"><span class="block font-editorial-sans text-[9px] uppercase tracking-[0.14em] mt-3">Shoes</span></a>
                <a href="{{ route('register.form') }}" class="border border-[#cfc8bc] bg-white p-3 hover:border-[#161413] transition text-center"><img src="https://images.unsplash.com/photo-1524805444758-089113d48a6d?auto=format&fit=crop&w=300&q=80" alt="Wristwatch" class="w-full h-24 object-contain"><span class="block font-editorial-sans text-[9px] uppercase tracking-[0.14em] mt-3">Watches</span></a>
